package io.okcollect.android.datamodel;

/**
 * Created by ramogiochola on 11/6/16.
 */
...
public class OrderItem {
    ...
    public String getClaimualid() {
        return claimualid;
    }

    public void setClaimualid(String claimualid) {
        this.claimualid = claimualid;
    }
    ...
    public void setBasketsize(String basketsize) {
    ...
    public void setAfricastalking(String africastalking) {
