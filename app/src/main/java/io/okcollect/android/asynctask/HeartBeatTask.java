...
public class HeartBeatTask extends AsyncTask<Void, Void, Boolean> {
    ...
    private io.okcollect.android.callback.HeartBeatCallBack heartBeatCallBack;
    private String message;

    public HeartBeatTask(io.okcollect.android.callback.HeartBeatCallBack heartBeatCallBack1) {
