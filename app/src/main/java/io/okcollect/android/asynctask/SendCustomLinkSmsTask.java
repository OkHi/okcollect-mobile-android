...
import io.okcollect.android.callback.SendCustomLinkSmsCallBack;
import io.okcollect.android.utilities.OkAnalytics;
...
public class SendCustomLinkSmsTask extends AsyncTask<Void, Void, String> {
    ...
    public SendCustomLinkSmsTask(Context context, SendCustomLinkSmsCallBack sendCustomLinkSmsCallBack, HashMap<String, String> parameters, String environment) {
        ...
        try {
            ...
            if (parameters.containsKey(io.okcollect.android.utilities.Constants.COLUMN_PHONECUSTOMER)) {
                postDataParams.put(io.okcollect.android.utilities.Constants.COLUMN_PHONECUSTOMER, parameters.get(io.okcollect.android.utilities.Constants.COLUMN_PHONECUSTOMER));
                displayLog(io.okcollect.android.utilities.Constants.COLUMN_PHONECUSTOMER + " @@@ " + parameters.get(io.okcollect.android.utilities.Constants.COLUMN_PHONECUSTOMER));
            } else {
                displayLog("we have no phonecustomer @@@ ");
            }

        } catch (Exception e) {
            displayLog(io.okcollect.android.utilities.Constants.COLUMN_PHONECUSTOMER + " @@@ error " + e.toString());
        }
        ...
        try {
            if (parameters.containsKey(io.okcollect.android.utilities.Constants.COLUMN_AFFILIATION)) {
                postDataParams.put(io.okcollect.android.utilities.Constants.COLUMN_AFFILIATION, parameters.get(io.okcollect.android.utilities.Constants.COLUMN_AFFILIATION));
                displayLog(io.okcollect.android.utilities.Constants.COLUMN_AFFILIATION + " " + parameters.get(io.okcollect.android.utilities.Constants.COLUMN_AFFILIATION));
            }
        } catch (Exception e) {
        ...
        try {
            ...
            if (parameters.containsKey(io.okcollect.android.utilities.Constants.COLUMN_BRANCH)) {
                postDataParams.put(io.okcollect.android.utilities.Constants.COLUMN_BRANCH, parameters.get(io.okcollect.android.utilities.Constants.COLUMN_BRANCH));
                displayLog(io.okcollect.android.utilities.Constants.COLUMN_BRANCH + " " + parameters.get(io.okcollect.android.utilities.Constants.COLUMN_BRANCH));
            }
