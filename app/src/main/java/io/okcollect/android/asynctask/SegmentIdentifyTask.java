...
import io.okcollect.android.callback.SegmentIdentifyCallBack;
import io.okcollect.android.utilities.BasicAuthInterceptor;
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            ...
            if (production.equalsIgnoreCase("PROD")) {
                writekey = io.okcollect.android.utilities.Constants.ANALYTICS_WRITE_KEY_PROD_OMTM;
            } else if (production.equalsIgnoreCase("DEVMASTER")) {
                writekey = io.okcollect.android.utilities.Constants.ANALYTICS_WRITE_KEY_DEV_OMTM;
