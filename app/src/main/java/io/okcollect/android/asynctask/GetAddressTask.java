...
import io.okcollect.android.callback.GetAddressCallBack;
import io.okcollect.android.datamodel.OrderItem;
...
public class GetAddressTask extends AsyncTask<Void, Void, String> {
    ...
    public GetAddressTask(Context context, GetAddressCallBack getAddressCallBack) {
        ...
        this.dataProvider = new io.okcollect.android.database.DataProvider(context);
        ...
        try {
            postDataParams.put("product", io.okcollect.android.utilities.Constants.product);
            postDataParams.put("appType", "android");
            postDataParams.put("productVersion", io.okcollect.android.BuildConfig.VERSION_NAME);
        } catch (Exception e) {
        ...
        try {
            ...
            switch (environment.toLowerCase()) {
                case "prod":
                    ...
                    appId = io.okcollect.android.utilities.Constants.PROD_APPLICATION_ID;
                    restApi = io.okcollect.android.utilities.Constants.PROD_REST_KEY;
                ...
                case "sandbox":
                    ...
                    appId = io.okcollect.android.utilities.Constants.SANDBOX_APPLICATION_ID;
                    restApi = io.okcollect.android.utilities.Constants.SANDBOX_REST_KEY;
                ...
                case "devmaster":
                    ...
                    appId = io.okcollect.android.utilities.Constants.DEVMASTER_APPLICATION_ID;
                    restApi = io.okcollect.android.utilities.Constants.DEVMASTER_REST_KEY;
                    urlString = "https://okhicore-development-master.back4app.com/getAddressByPhone_forHD";
                    break;
                case "dev1":
                    postDataParams.put("userId", io.okcollect.android.utilities.Constants.DEV1_USERID);
                    appId = io.okcollect.android.utilities.Constants.DEV1_APPLICATION_ID;
                    restApi = io.okcollect.android.utilities.Constants.DEV1_REST_KEY;
                    urlString = "https://okhi-d1.back4app.io/getAddressByPhone_forHD";
                    break;
                case "dev3":
                    postDataParams.put("userId", io.okcollect.android.utilities.Constants.DEV3_USERID);
                    appId = io.okcollect.android.utilities.Constants.DEV3_APPLICATION_ID;
                    restApi = io.okcollect.android.utilities.Constants.DEV3_REST_KEY;
                    urlString = "https://okhicore-development-3.back4app.com/getAddressByPhone_forHD";
                    break;
                case "dev4":
                    postDataParams.put("userId", io.okcollect.android.utilities.Constants.DEV4_USERID);
                    appId = io.okcollect.android.utilities.Constants.DEV4_APPLICATION_ID;
                    restApi = io.okcollect.android.utilities.Constants.DEV4_REST_KEY;
                                    ...
                                    */
                                    ...
                                    if (orderItem.getLat() != null) {
                                        if (orderItem.getLat() != 0.0) {
                                            ...
                                            contentValues.put(io.okcollect.android.utilities.Constants.COLUMN_PHONECUSTOMER, phoneNumber);
                                            contentValues.put(io.okcollect.android.utilities.Constants.COLUMN_ROUTE, orderItem.getRoute());
                                            contentValues.put(io.okcollect.android.utilities.Constants.COLUMN_STREETNAME, orderItem.getStreetName());
                                            contentValues.put(io.okcollect.android.utilities.Constants.COLUMN_PROPERTYNAME, orderItem.getPropertyname());
                                            contentValues.put(io.okcollect.android.utilities.Constants.COLUMN_DIRECTION, orderItem.getDirection());
                                            contentValues.put(io.okcollect.android.utilities.Constants.COLUMN_LOCATIONNICKNAME, orderItem.getLocationNickName());
                                            contentValues.put(io.okcollect.android.utilities.Constants.COLUMN_CLAIMUALID, ualId);
                                            contentValues.put(io.okcollect.android.utilities.Constants.COLUMN_IMAGEURL, "");
                                            contentValues.put(io.okcollect.android.utilities.Constants.COLUMN_LOCATIONNAME, orderItem.getLocationNickName());
                                            contentValues.put(io.okcollect.android.utilities.Constants.COLUMN_BRANCH, "app_interswitch");
                                            contentValues.put(io.okcollect.android.utilities.Constants.COLUMN_LAT, orderItem.getLat());
                                            contentValues.put(io.okcollect.android.utilities.Constants.COLUMN_LNG, orderItem.getLng());
