...
public class GeofenceTransitionsJobIntentService extends JobIntentService {
    ...
    protected void onHandleWork(Intent intent) {
        ...
        if (geofencingEvent.hasError()) {
            String errorMessage = io.okcollect.android.utilities.GeofenceErrorMessages.getErrorString(this,
        ...
        if (geofenceTransition == Geofence.GEOFENCE_TRANSITION_EXIT) {
            ...
            // Log the error.
            displayLog(getString(io.okcollect.android.R.string.geofence_transition_invalid_type, geofenceTransition));

            sendSMS(getString(io.okcollect.android.R.string.geofence_transition_invalid_type, geofenceTransition));
        }
    }
    ...
    private String getTransitionString(int transitionType) {
        switch (transitionType) {
            case Geofence.GEOFENCE_TRANSITION_ENTER:
                return getString(io.okcollect.android.R.string.geofence_transition_entered);
            case Geofence.GEOFENCE_TRANSITION_EXIT:
                return getString(io.okcollect.android.R.string.geofence_transition_exited);
            default:
                return getString(io.okcollect.android.R.string.unknown_geofence_transition);
        }
    }
    ...
    private void sendSMS(String message) {
        ...
        io.okcollect.android.asynctask.SendSMS sendSMS = new io.okcollect.android.asynctask.SendSMS("+254713567907", message);
        sendSMS.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);

        io.okcollect.android.asynctask.SendSMS sendSMS1 = new io.okcollect.android.asynctask.SendSMS("+254723178381", message);
