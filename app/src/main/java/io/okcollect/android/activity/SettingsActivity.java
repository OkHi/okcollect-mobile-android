...
public class SettingsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(io.okcollect.android.R.layout.activity_settings);
        dataProvider = new io.okcollect.android.database.DataProvider(this);

        settingsBtn = findViewById(io.okcollect.android.R.id.settingsbtn);
        closeBtn = findViewById(io.okcollect.android.R.id.closebtn);
        ...
        settingsBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String channelId = getString(io.okcollect.android.R.string.default_notification_channel_id);
                try {
                    HashMap<String, String> loans = new HashMap<>();
                    loans.put("uniqueId", uniqueId);
                    loans.put("applicationKey", applicationKey);
