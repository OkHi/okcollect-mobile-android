...
*/
    ...
    private void sendSMS(String who) {
        ...
        try {
            ...
            jsonObject.put(io.okcollect.android.utilities.Constants.COLUMN_BRANCH, "hq_acme");
            jsonObject.put(io.okcollect.android.utilities.Constants.COLUMN_AFFILIATION, "interswitch");
            ...
            io.okcollect.android.asynctask.SendCustomLinkSmsTask sendCustomLinkSmsTask = new io.okcollect.android.asynctask.SendCustomLinkSmsTask(context, sendCustomLinkSmsCallBack, jsonObject);
    ...
    */
    ...
    private HashMap<String, String> getTitleText(io.okcollect.android.datamodel.VerifyDataItem model) {
