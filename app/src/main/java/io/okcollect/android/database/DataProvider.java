...
*/
    ...
    public void deleteAddressListItemUAL(String ualid) {
        ...
        String selection = io.okcollect.android.utilities.Constants.COLUMN_CLAIMUALID + " = ? ";
        ...
        try {
            ...
            database.delete(io.okcollect.android.utilities.Constants.TABLE_NAME_RUNLIST, selection, selectionArgs);
    ...
    public void deleteAllAddresseses() {
        ...
        try {
            ...
            database.delete(io.okcollect.android.utilities.Constants.TABLE_NAME_RUNLIST, null, null);
    ...
    public List<io.okcollect.android.datamodel.AddressItem> getAddressListItem(String deliveryId) {
        displayLog("List<AddressItem> getAddressListItem(" + deliveryId + ") method called");

        List<io.okcollect.android.datamodel.AddressItem> ArtcaffeRunList = new ArrayList<io.okcollect.android.datamodel.AddressItem>();
        ...
        try {
            ...
            Cursor cursor = database.query(io.okcollect.android.utilities.Constants.TABLE_NAME_RUNLIST, null, selection, selectionArgs, null, null, null);
            displayLog("List<AddressItem> getAddressListItem method executed");
            cursor.moveToFirst();
            while (!cursor.isAfterLast()) {
                io.okcollect.android.datamodel.AddressItem AddressItem = cursorToAddressListItem(cursor);
    ...
    public List<io.okcollect.android.datamodel.AddressItem> getAllAddressList() {

        displayLog("getAllAddressList method called ");

        List<io.okcollect.android.datamodel.AddressItem> artcaffeRunList = new ArrayList<>();
        Cursor cursor;
        try {
            try {
                openRead();
            ...
            cursor = database.query(io.okcollect.android.utilities.Constants.TABLE_NAME_RUNLIST, null, null, null, null, null, null);
    ...
    public void deleteAllStuff() {
        ...
        try {
            ...
            database.delete(io.okcollect.android.utilities.Constants.TABLE_NAME_STUFF, null, null);
